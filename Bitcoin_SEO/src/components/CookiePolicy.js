        ...
        <div className="PrivacyPolicy_container__9i2D-">
          <div className="PrivacyPolicy_innerContainer__F1+CV">
            ...
            <div className="PrivacyPolicy_section__7mnwT">
              <p>This Cookie Policy explains how IQ International Pte. Ltd ("IQ Hub," "we," "us," or "our") uses cookies and similar tracking technologies on our website.</p>
            </div>
            <div className="PrivacyPolicy_section__7mnwT">
              <h4>What Are Cookies?</h4>
              <p>Cookies are small text files that are stored on your device (computer, tablet, or mobile) when you visit a website. They help the website remember your actions and preferences over time.</p>
            </div>
            <div className="PrivacyPolicy_section__7mnwT">
            ...
            <div className="PrivacyPolicy_section__7mnwT">
              ...
              <p>Some cookies on our site are set by third-party services that appear on our pages. We do not control the dissemination of these cookies.</p>
            </div>
            <div className="PrivacyPolicy_section__7mnwT">
            ...
            <div className="PrivacyPolicy_section__7mnwT">
              ...
              <i>
                <p>
                  This Privacy Policy was last updated on 01/02/2026
                </p>
              </i>
            </div>
            <div className="PrivacyPolicy_section__7mnwT">
              <h5>
                ...
                <button style={{ background: 'none', color: 'inherit', cursor: 'pointer', padding: '0px', fontSize: '16px', fontWeight: '800', border: '0px', textDecoration: 'underline' }}>Cookie preferences</button>
              </h5>
            </div>
          </div>
        </div>
