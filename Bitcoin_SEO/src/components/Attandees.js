...
//     return result;
//   };
//   const leaderChunks = chunkArray(leadersList, 6);
...
//   console.log("chunkedLeaders: ", chunkedLeaders);
...
//                   <Slider {...settings}>
//                     {chunkedAttendees.map((attendee) => (
//                       <div className="PastAttendees_cardContainerInner__i-ICs">
...
//                   </button>
//                   <div>
//                     <Slider  ref={sliderRef} {...leadersSettings}>
//                       {chunkedLeaders.map((leader) => (
//                         <div className="Operators_cardContainerInner__Cmd5S">
//                           {leader.items.map((data) => (
//                             <div className="Operators_card__YB2Bt">
//                               <img
//                                 src={data.leaderLogo}
//                                 alt={data.leaderName}
//                               ></img>
