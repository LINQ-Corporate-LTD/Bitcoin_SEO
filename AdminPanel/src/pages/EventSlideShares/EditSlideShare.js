...
const EditSlideShare = ({
    ...
    const submitBtnClk = (e) => {
        ...
        if (author === "") {
            ...
            fetch("https://harsh7541.pythonanywhere.com/admin1/editslideShare", requestOptions)
                        ...
                        <div className="row gy-4 mb-3">
                            ...
                            <div className="col-md-12">
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        className={`form-control ${companyNameError ? "border-danger " : ""
                                            }`}
                            ...
                            <div className="col-md-12">
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        className={`form-control ${slideShareHeadingError ? "border-danger " : ""
                                            }`}
                            ...
                            <div className="col-md-12">
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        className={`form-control ${projectYearError ? "border-danger " : ""
                                            }`}
                            ...
                            <div className="col-md-12">
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        className={`form-control ${pptLinkError ? "border-danger " : ""
                                            }`}
